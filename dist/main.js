...
function hoursLoad(_ref) {
  ...
  var html = opening.map(function (_ref2) {
    var hour = _ref2.hour,
    ...
    block += "\n      <li value=\"".concat(hour, "\" class=\"hour ").concat(available ? "hour-available" : "hour-unavailable", "\">\n        ").concat(hour, "\n      </li>\n    ");
    return block;
  });
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          ...
          return _context.a(2, alert("Please, enter your name."));
        case 2:
          ...
          return _context.a(2, alert("Please, select an hour."));
        case 3:
          ...
          when = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(selectedDate.value).add(Number(hour), "hour").format("YYYY-MM-DD HH:mm");
          id = new Date().getTime();
          _context.n = 4;
          return (0,_services_schedules_new_js__WEBPACK_IMPORTED_MODULE_1__.schedulesNew)({
            id: id,
            name: name,
            when: when
          });
